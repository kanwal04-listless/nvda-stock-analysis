...
The script:
1. Fetches 1 year of NVDA daily price data
2. Computes short-term (20-day) and long-term (50-day) moving averages
3. Flags a bullish/bearish trend signal based on which moving average is higher
4. Computes annualized rolling volatility from daily returns
5. Saves a chart (`nvda_analysis.png`) and a CSV export of the full dataset
